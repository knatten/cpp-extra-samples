...
- [**MaskingROI**](https://github.com/zivid/cpp-extra-samples/tree/master/MaskingROI)  - This example shows how to import a ZDF point cloud, mask it using OpenCV, and convert it to PCL format.
	- **Dependencies:**
		- [OpenCV](https://opencv.org/) version 4.0.1-dev or newer
		- [PCL](http://pointclouds.org/) version 1.9.1
